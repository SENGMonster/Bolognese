...
set :user, "user62571957"


# password to login to the target server
set :password, "4tq1I3YnaR"
...
# repository location
set :repository, "ssh://git@github.com/SENGMonster/Bolognese.git"
...
set :deploy_to, "/home/user62571957/rails1"
...
namespace :railshoster do
  ...
  task :appurl do
    ...
    puts "\nhttp://user62571957-1.ny.railshoster.de"    
    puts "\n"
  end
end
