...
class SeminarsControllerTest < ActionController::TestCase
  ...
  test "should create seminar" do
    assert_difference('Seminar.count') do
      post :create, seminar: { abschluss: @seminar.abschluss, description: @seminar.description, title: @seminar.title }
    end
  ...
  test "should update seminar" do
    put :update, id: @seminar, seminar: { abschluss: @seminar.abschluss, description: @seminar.description, title: @seminar.title }
    assert_redirected_to seminar_path(assigns(:seminar))
  end
